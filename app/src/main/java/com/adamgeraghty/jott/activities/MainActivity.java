...
import com.adamgeraghty.jott.data.DatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(R.string.title_edit).withIcon(FontAwesome.Icon.faw_edit).withIdentifier(2),
